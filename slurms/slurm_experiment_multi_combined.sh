...
singularity exec --nv deoxys.sif python experiments/experiment_multi_combined.py $1 $PROJECTS/ngoc/OUS_HNC/perf/$2 --temp_folder $SCRATCH_PROJECTS/ceheads/ous-hnc/perf/$2 --analysis_folder $SCRATCH_PROJECTS/ceheads/ous-hnc/analysis/$2 --epochs $3 ${@:4}
